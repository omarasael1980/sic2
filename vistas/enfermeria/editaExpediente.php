       ...
       <div class="row">
        ...
        <div class="row">
                ...
                <div class="list-group">
                        ...
                        <a class="list-group-item text-center list-group-item-action" href="expedienteAlumno.php?id=<?=$id?>"><p><i class="fa-regular fa-folder"></i><?=$espacios?> Expedientes </p></a>
                     <br>
                        <a class="btn-primary list-group-item text-center list-group-item-action" href="expedienteAlumno.php?id=<?=$id?>"><p><i class="fa-solid fa-file-pen"></i><?=$espacios?> Edita Expediente </p></a>
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 ">
          ...
          <div class="col-lg-1 col-md-1 col-sm-0 col-xs-0 "></div>
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 ">
                <form action="../../controlador/enfermeria/editarExpediente.php" method="post">
                    ...
                    <h6 class=""> <b>  Selecciona que alergias tiene el Alumno:</b></h6>
                <input type="hidden" name="folio" id="folio" value="<?=$expediente[0]->idEM?>">
                <input type="hidden" name="idalumno" id="idalumno" value ="<?=$expediente[0]->estudiantes_idestudiantes?>">
                    <div class="row">
              ...
              <h6 class=""> <b>  Selecciona que enfermedades crónicas tiene el alumno:</b></h6>
              <div class="row">
                        <!-- incia listado de alergias -->
              ...
              <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" id="grupo__medicamento">
                <h6 class=""><b> Ingresa un medicamento:</b></h6>
