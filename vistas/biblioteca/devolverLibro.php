...
<!-- termina barra lateral izquierda -->
        ...
        <!--contenedor central -->  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 ">
        
        <div class="container"><!--inicia contenedor principal-->
    <div class="row"><!--inicia row principal-->
    <h1 class="text-center">Devolver libro</h1>
            ...
            <div class="col-lg-6 col-md-8 col-sm-8 col-xs-12"> 
                    ...
                    <b>Folio:</b>   <input class="form-control" type="text" name="idPrestamo" readonly value="<?=$p->idPrestamos?>">
                  <b>Título:</b>   <input class="form-control" type="text" name="titulo" readonly value="<?=$p->titulo?>">
