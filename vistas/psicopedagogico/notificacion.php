...
<!--contenedor central -->
<center><h1>Notificación</h1></center>
<hr>
...
<div class="row">
  ...
  <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
    <form action="../../controlador/psicopedagogico/agregarNotificacion.php" class="formulario" id="formulario"  method="post">
           
           <div class="row">
               <div class="col-lg-12"><input type="text" class="text" id="folio" name="folio" value="<?=$caso[0]->idatencion_psico?>" hidden></div>
               
           </div>
               <center><h6>Nueva Notificación</h6></center>
           <!--input fecha-->
           ...
           <div class="form-group " id="grupo__descripcion"> 
                <div class="form-group-input  ">
                   <label for="descripcion" class="form-label form-control2"> <b> Descripción:</b>
                       <textarea name="descripcion" spellcheck="true" lang="es"  onkeyup="validadescripcion(this.value)" rows="7" id="descripcion" required class="form-control"></textarea>
                   ...
                   <!-- termina input descripcion -->
                       <br>
                       <div class="col-lg-1 col-md-1 col-sm-0 col-xs-0"></div>
                       <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6"><button type="submit"  name = "bEnviar" onclick="validarForm(event)" id="bEnviar"class="nav-button-cargar">Guardar</button></div>
                       <div class="col-lg-2 col-md-2 col-sm-0 col-xs-0"></div>
                       <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6"> <a href="pprincipal.php" class="nav-button-cargar">Cancelar</a></div>
