       ...
       <div class="row">
        ...
        <div class="row">
                ...
                <div class="list-group">
                        ...
                        <a href="historialPsico.php?id=" class="list-group-item text-center list-group-item-action"><p><i class="fa-solid fa-file-lines"></i> <?=$espacios?>Historial Alumno</p></a>
